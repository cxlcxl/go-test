...
func (u *userToken) GenerateToken(userid int64, username, realName, phone, avatar string, expireAt int64) (tokens string, err error) {
...
func (u *userToken) RefreshToken(oldToken, clientIp, platform string) (newToken string, res bool) {
	// 解析用户token的数据信息
